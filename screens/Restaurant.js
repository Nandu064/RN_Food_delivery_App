...
import { SafeAreaView, View, Text, StyleSheet, TouchableOpacity, Image, FlatList,Animated} from 'react-native'
            ...
            >
                {
                    restaurant?.menu.map((item,index)=>(
                        ...
                        >
                            ...
                            >
                                <Text style={{ marginVertical: 10, textAlign: 'center', ...FONTS.h2 }}>{item.name} - Rs.{item.price.toFixed(2)}</Text>
